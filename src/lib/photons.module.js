...
class AnimatedSpriteRenderer extends Renderer {
    ...
    constructor(atlas, interpolateAtlasFrames = false, blending = THREE$1.NormalBlending) {
        super();
