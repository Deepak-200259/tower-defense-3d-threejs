...
export default class RedPantherEnemy {
    ...
    constructor({ resourceName = 'redPantherModel', position = { x: 0, y: 0, z: 0 }, scale = 0.15, movePath, speed, levelData }) {
        ...
        if (this.debug.active) {
            this.debugFolder = this.debug.ui.addFolder('red panther enemy')
        }
    ...
    setAnimation() {
        ...
        // Actions (ordered as requested)
        this.animation.actions = {}
        this.animation.actions.attack = this.animation.mixer.clipAction(this.resource.animations[0])
        ...
        this.animation.actions.idle = this.animation.mixer.clipAction(this.resource.animations[4])
        this.animation.actions.roar = this.animation.mixer.clipAction(this.resource.animations[5])
        ...
        if (this.debug.active) {
            const debugObject = {
                ...
                playRoar: () => this.animation.play('roar'),
            }
            ...
            this.debugFolder.add(debugObject, 'playRoar')
        }
    }
